...
@onready var target: Node3D = $"Armature/Skeleton3D/PhysicalBoneSimulator3D/Physical Bone mixamorig_Head/Target"
@onready var body_bones: Array[PhysicalBone3D] = [$"Armature/Skeleton3D/PhysicalBoneSimulator3D/Physical Bone mixamorig_Hips", $"Armature/Skeleton3D/PhysicalBoneSimulator3D/Physical Bone mixamorig_Spine2"]
@onready var left_hand: PhysicalBone3D = $"Armature/Skeleton3D/PhysicalBoneSimulator3D/Physical Bone mixamorig_LeftForeArm"
@onready var right_hand: PhysicalBone3D = $"Armature/Skeleton3D/PhysicalBoneSimulator3D/Physical Bone mixamorig_RightForeArm"

@onready var body_control: Node3D = $Armature/BodyControl
@onready var left_leg_control: Node3D = $Armature/LeftLegControl
@onready var right_leg_control: Node3D = $Armature/RightLegControl
@onready var left_arm_control: Node3D = $Armature/LeftArmControl
@onready var right_arm_control: Node3D = $Armature/RightArmControl
...
@onready var jump_ray_cast_3d: RayCast3D = $"Armature/Skeleton3D/PhysicalBoneSimulator3D/Physical Bone mixamorig_Hips/JumpRayCast3D"
...
@onready var left_grab_joint: PinJoint3D = $"Armature/Skeleton3D/PhysicalBoneSimulator3D/Physical Bone mixamorig_LeftForeArm/GrabJoint"
@onready var right_grab_joint: PinJoint3D = $"Armature/Skeleton3D/PhysicalBoneSimulator3D/Physical Bone mixamorig_RightForeArm/GrabJoint"
...
func _physics_process(_delta: float) -> void:
	camera_root.global_transform.origin = target.global_transform.origin
